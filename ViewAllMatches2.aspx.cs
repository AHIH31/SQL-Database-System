...
namespace MileS3
{
    public partial class ViewAllMatches2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string time = "'" + Globals.StartTimeAllMatches + "'";
            rdr.Close();
            SqlDataAdapter SqlDa = new SqlDataAdapter($"select * from availableMatchesToAttend({time})", conn);
